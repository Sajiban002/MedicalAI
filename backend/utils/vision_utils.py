...
def init_vision_api():
    ...
    try:
        if settings.google_credentials_path:  # Use the path from settings
...
# 1. First, let's enhance the find_medical_terms function to be more robust and provide more context
